...
export function FooterSection() {
  ...
  return (
    <footer className="relative pt-20 pb-[120px] md:pb-12 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto w-full glass-card rounded-[2.5rem] p-8 md:p-12 border-t border-white/20 shadow-2xl flex flex-col gap-10">
        
        {/* Top Info & Socials */}
        <div className="flex flex-col items-center text-center gap-8 md:flex-row md:items-center md:text-left md:justify-between">
          <div className="flex flex-col gap-2">
            <h3 className="text-3xl md:text-4xl font-black tracking-tight text-gradient">
              {personalInfo.name}
            </h3>
